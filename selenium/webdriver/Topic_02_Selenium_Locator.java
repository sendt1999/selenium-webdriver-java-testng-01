...
public class Topic_02_Selenium_Locator {
	...
	public void TC_07_Css() {
		...
		//driver.get("https://demo.nopcommerce.com/register?returnUrl=%2Fcustomer%2Faddresses");
		
		// 1
		//driver.findElement(By.cssSelector("//input[@data-val-required='First name is required.']).sendKeys("Selenium");
	...
	public void TC_08_Xpath() {
		...
		// 1
		driver.findElement(By.xpath("input#FirstName")).sendKeys("Selenium");
